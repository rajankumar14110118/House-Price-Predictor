...
if not os.path.exists(MODEL_FILE):
    ...
    for train_index, test_index in split.split(housing, housing['income_cat']):
        ...
        test_set.to_csv('input.csv', index=False)  # ✅ Corrected this line
    ...
    predictions = model.predict(transformed_input)  # ✅ Fixed: variable was named `predictions`, not `prediction`
